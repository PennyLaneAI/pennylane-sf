...
If posting a PennyLane-SF issue, delete everything above the dashed line, and fill in the template.
...
* **Installation method:**
  ...
  Did you install PennyLane-SF via pip, or directly from the GitHub repository source code?

  If installed via GitHub, what branch/commit did you use? You can get this information by opening a terminal in the
  PennyLane-SF source code directory, and pasting the output of:
